...
<script src="js/bootstrap.min.js"></script>
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="index.php"><strong>Online Notice Board</strong></a></li>
	  ...
	  <li><a href="index.php?option=about"><span class="glyphicon glyphicon-user"></span>All Notices</a></li>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/Shivaji-University-Kolhapur.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="images/garden12.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
	 ...
	 <div class="item">
      <img src="images/005_2_FINAL-.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2></h2>
		Welcome to Online Notice Board";
		}
		?>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="#"> Developed by Rutuja And Pranali</a></li>
